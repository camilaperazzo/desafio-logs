    ...
    public class clLog
    {
        ...
        public void WriteLog(string fpData/*, string fpFileName*/)
        {
            ...
            if (fpData == "")
            {
                ...
                path = directory + DefaultFileName + ".log";
                oldpath = directory + DefaultFileName + "_old.log";
            }
            else
            {
                path = directory + "archieve"+".log";
                oldpath = directory + "archieve" + "_old.log";
            }
